                        ...
                        <div class="col-md-12">
                            <div class="d-flex flex flex-row justify-content-between align -items-center border-bottom pb-1">
                                <h3 class="text-secondary">
                                    <i class="fas fa-bars"></i> Repports
                                </h3>
                            ...
                            @isset($total)
                                <h4 class="text-primary mt-4 mb-2 font-weight-bold">
                                    Repport de {{ $startDate }} à {{ $endDate }}
                                </h4>
                                        ...
                                        <form action="{{ route('reports.export') }}" method="post">
                                            ...
                                            <div class="form-group">
                                                <button class="btn btn-danger">
                                                    Génerer Le Raport Excel
                                                </button>
                                            </div>
                                        </form>
                                    </span>
                                <span>
                                    <form action="{{ route('reports.exporttopdf') }}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <input type="hidden" name="from" value="{{ $startDate }}" class="form-control">
                                        </div>
