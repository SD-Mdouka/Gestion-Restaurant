            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="d-flex flex flex-row justify-content-between align -items-center border-bottom pb-1">
                                <h3 class="text-secondary">
                                    <i class="fas fa-clipboard"></i> List Menus
                                </h3>
                            ...
                            <table class="table table-hover table-responsive-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td class="d-flex flex flex-row justify-content-center align -items-center">
                                          <a href="{{ route("menus.edit",$menu->slug) }}" class="btn btn-warning mr-1">
                                            ...
                                            <form id="{{ $menu->id }}" action="{{ route("menus.destroy",$menu->slug) }}" method="post">
                                                ...
                                                onclick="event.preventDefault();
                                                    if(confirm('Voulez vous supprimer la menu {{ $menu->title }} ?'))
