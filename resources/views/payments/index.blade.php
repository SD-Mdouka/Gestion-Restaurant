...
@section("content")
<div class="container">
    <form id="add_sale" action="{{ route("sales.store") }}" method="post">
        @csrf
        ...
        <div class="row justify-content-center mt-2">
            <div class="col-md-12 card p-3">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    @foreach ($categories as $category)
                        <li class="nav-item">
                            ...
                            class="nav-link mr-1 {{ $category->slug === "salad-maroc" ? "active" : "" }}"
                ...
                <div class="tab-content" id="pills-tabcontent">
                    @foreach ($categories as $category)
                       <div class="tab-pane {{ $category->slug === "salad-maroc" ? "active show fade" : "" }}"
                    ...
                    <div class="col-md-6 mx-auto">
                        <div class="form-group">
                            <select name="servant_id"class="form-control">
                                <option value="1" selected disabled>Serveur</option>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="total_received"
                            id="total_received" class="form-control" placeholder="Total"/>
                            <div class="input-group-append">
                                <div class="input-group-text">.00</div>
                            </div>
                        </div>
                        <div class="input-group mb-3">
                            ...
                            id="title" class="form-control" placeholder="Reset"/>
                            <div class="input-group-append">
                                <div class="input-group-text">.00</div>
                            </div>
                        </div>
